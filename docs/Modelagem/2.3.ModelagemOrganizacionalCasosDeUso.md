...
| `2.0` | 07/05/2025 | Adiciona versão 2.0 Casos de uso, criamos um `<<include>>` de "enviar memória" para "escolher TAGs", também mudamos as setas para o padrão UML  | Manuella, Maria Eduarda, Pedro, Mateus | Marcos e Gustavo | |  