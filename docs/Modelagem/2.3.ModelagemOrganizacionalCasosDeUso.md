...
| `1.2` | 09/05/2025 | Criamos um `<<extends>>` de "Enviar Memória" para "Administrar Memória" e a especificação do caso de uso "Enviar Memória", [ata de reunião](../Atas/ata_reuniao8.md)  | Marcos, Manuella |  |  |