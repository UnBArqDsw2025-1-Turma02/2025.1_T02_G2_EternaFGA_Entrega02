...
Este caso de uso descreve o processo pelo qual um usuário pode submeter uma nova memória para o sistema EternaFGA.
...
| :----: | :--------: | :-----------------------------------: | :-------: | :---------: | :-------------------: |
| `1.0`  | 09/05/2025 | Adiciona especificação de caso de uso |  Edilson  |   -------   |                       |
